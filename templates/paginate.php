...
<div class="tablenav-pages">
	...
	<span class="pagination-links">
		...
		<span class="screen-reader-text">Current Page</span><span id="table-paging" class="paging-input"><span class="tablenav-paging-text">
		<input class="current-page" id="current-page-selector" type="text" name="paged" 
			value="<?php echo $page_current ?>" size="1" aria-describedby="table-paging"> of <span class="total-pages"><?php echo $total_pages ?></span></span></span>
